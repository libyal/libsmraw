...
void (*smrawtools_signal_signal_handler)( smrawtools_signal_t ) = NULL;
             ...
             unsigned long signal )
{
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( smrawtools_signal_signal_handler != NULL )
			{
				smrawtools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
 ...
 */
void smrawtools_signal_initialize_memory_debug(
      void )
{
	int flag = 0;
 ...
 */
int smrawtools_signal_attach(
     void (*signal_handler)( smrawtools_signal_t ),
     libcerror_error_t **error )
{
	static char *function = "smrawtools_signal_attach";
...
#if defined( _MSC_VER )
	smrawtools_signal_initialize_memory_debug();
#endif
     ...
     libcerror_error_t **error )
{
	...
	smrawtools_signal_signal_handler = NULL;
