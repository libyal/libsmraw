...
#if !defined( _SMRAWTOOLS_GETOPT_H )
#define _SMRAWTOOLS_GETOPT_H
...
typedef struct smrawtools_option smrawtools_option_t;

struct smrawtools_option
{
...
#define smrawtools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t smrawtools_getopt(
                  int argument_count,
...
void smrawtools_getopt_wrapped_fprint(
      FILE *stream,
...
void smrawtools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const smrawtools_option_t *options,
      int number_of_options );

int smrawtools_getopt_get_options_string(
     const smrawtools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _SMRAWTOOLS_GETOPT_H ) */
