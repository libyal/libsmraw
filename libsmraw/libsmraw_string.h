...
#define libsmraw_string_search( string, character, size ) \
	(libsmraw_character_t *) narrow_string_search( (char *) string, (int) character, size )

#define libsmraw_string_search_reverse( string, character, size ) \
	(libsmraw_character_t *) narrow_string_search_reverse( (char *) string, (int) character, size )
