     ...
     liberror_error_t **error )
{
	...
	if( *values_table == NULL )
	{
		...
		*values_table = (libsmraw_values_table_t *) memory_allocate(
		                                            sizeof( libsmraw_values_table_t ) );
		...
		if( memory_set(
		     *values_table,
		     0,
		     sizeof( libsmraw_values_table_t ) ) == NULL )
		{
			liberror_error_set(
			 error,
			 LIBERROR_ERROR_DOMAIN_MEMORY,
...
int libsmraw_values_table_free(
     ...
     liberror_error_t **error )
{
	static char *function     = "libsmraw_values_table_free";
...
int libsmraw_values_table_get_index(
     ...
     liberror_error_t **error )
{
	static char *function     = "libsmraw_values_table_get_index";
	int values_table_iterator = 0;
...
int libsmraw_values_table_get_identifier_size(
     ...
     liberror_error_t **error )
{
	static char *function = "libsmraw_values_table_get_identifier_size";
...
int libsmraw_values_table_get_identifier(
     ...
     liberror_error_t **error )
{
	static char *function           = "libsmraw_values_table_get_identifier";
...
int libsmraw_values_table_set_identifier(
     ...
     liberror_error_t **error )
{
	static char *function = "libsmraw_values_table_set_identifier";
...
int libsmraw_values_table_get_value_size(
     ...
     liberror_error_t **error )
{
	static char *function = "libsmraw_values_table_get_value_size";
	int index             = 0;
	int result            = 0;
	...
	result = libsmraw_values_table_get_index(
	          values_table,
	          identifier,
	          identifier_length,
	          &index,
...
int libsmraw_values_table_get_value(
     ...
     liberror_error_t **error )
{
	static char *function      = "libsmraw_values_table_get_value";
...
int libsmraw_values_table_set_value(
     ...
     liberror_error_t **error )
{
	static char *function = "libsmraw_values_table_set_value";
	int index             = 0;
	int result            = 0;
	...
	else if( result == 0 )
	{
		...
		if( libsmraw_values_table_set_identifier(
		     values_table,
		     index,
		     identifier,
		     identifier_length,
