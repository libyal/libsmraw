...
enum LIBSMRAW_ARGUMENT_ERROR
{
	 ...
	 */
	LIBSMRAW_ARGUMENT_ERROR_VALUE_OUT_OF_RANGE     = 7,
...
enum LIBSMRAW_COMPRESSION_ERROR
{
	 ...
	 */
	LIBSMRAW_COMPRESSION_ERROR_UNCOMPRESS_FAILED   = 2
};
...
enum LIBSMRAW_INPUT_ERROR
{
	 ...
	 */
	LIBSMRAW_INPUT_ERROR_MISSING_LAST_SEGMENT_FILE = 5,

	/* The last section is missing from the input
	 */
	LIBSMRAW_INPUT_ERROR_MISSING_LAST_SECTION      = 6
};
...
enum LIBSMRAW_RUNTIME_ERROR
{
	 ...
	 */
	LIBSMRAW_RUNTIME_ERROR_VALUE_OUT_OF_RANGE      = 12,
