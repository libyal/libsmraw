 ...
 * Returns the number of bytes read or -1 on error
 *
 * This function is deprecated use libsmraw_handle_read_buffer_at_offset instead
 */
LIBSMRAW_DEPRECATED \
LIBSMRAW_EXTERN \
 ...
 * Returns the number of input bytes written, 0 when no longer bytes can be written or -1 on error
 *
 * This function is deprecated use libsmraw_handle_write_buffer_at_offset instead
 */
LIBSMRAW_DEPRECATED \
LIBSMRAW_EXTERN \
